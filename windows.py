...
#from ..spectools import subselect_spectra
from matplotlib.widgets import SpanSelector, Cursor


# This functions plots the windows.
def plot_windows(windows,altura):
    """
    Plots the windows
    ...
    for i in range(int(len(windows)/2)):
        plt.hlines(altura, windows[2*i], windows[2*i+1], colors='b')
    #Plot the vertical dashed lines
    for i in windows:
        plt.vlines(i, 0, altura, colors='b', linestyles='dashed')
